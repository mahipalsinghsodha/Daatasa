...
const Field = ({ id, label, type = 'text', value, onChange, required, isTextarea }) => {
  ...
  return (
    <div className="relative">
      {isTextarea
        ? <textarea {...commonProps} className="w-full px-3.5 text-sm font-medium outline-none transition-all" rows={5} style={{ ...commonProps.style, minHeight: '120px', resize: 'none' }} />
