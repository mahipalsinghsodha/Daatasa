...
const Terms = () => (
  <PolicyPage icon="📋" accentClass="from-orange-400 to-amber-400" tag="Legal"
    ...
    <PolicySection id="section-5" title="Governing Law">
      <p>These Terms shall be governed and construed in accordance with the laws of <strong className="text-slate-900">India</strong>. Any disputes shall be subject to the exclusive jurisdiction of courts in Mumbai, Maharashtra.</p>
    </PolicySection>
    ...
    <PolicySection id="section-6" title="Contact Us">
      ...
      <div className="mt-3 inline-block p-4 bg-slate-50 border border-slate-200 rounded-2xl">
        <a href="mailto:support@dhanifresh.com" className="text-sm font-bold text-orange-500 hover:underline">📧 support@dhanifresh.com</a>
        <p className="text-xs text-slate-500 mt-0.5">We respond within 48 hours</p>
      </div>
    </PolicySection>
  </PolicyPage>
)
