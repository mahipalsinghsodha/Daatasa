    ...
    <div className="flex-1 flex items-center justify-center px-4 py-20">
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-12">
          ...
          <Link to="/products" className="btn-secondary w-full sm:w-auto">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              <Link key={link.to} to={link.to}
                ...
                onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(19,60,42,0.25)'; e.currentTarget.style.background = 'rgba(19,60,42,0.06)'; e.currentTarget.style.color = 'var(--brand-primary)' }}
