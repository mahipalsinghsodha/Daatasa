                  ...
                  {CATEGORIES.map(cat => (
                    <button
                      ...
                      style={{
                        padding:      '10px 12px',
                        borderRadius: '10px',
                        border:       `2px solid ${category === cat.id ? '#f97316' : '#e2e8f0'}`,
                        background:   category === cat.id ? '#fff7ed' : '#f8fafc',
                        cursor:       'pointer',
                        textAlign:    'left',
                        fontSize:     '13px',
                        color:        category === cat.id ? '#ea580c' : '#374151',
              ...
              <div style={{ flex: 1, overflowY: 'auto', padding: '16px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                ...
                {agentTyping && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <div style={{ background: '#f1f5f9', borderRadius: '16px 16px 16px 4px', padding: '10px 14px', display: 'flex', gap: '4px' }}>
                      {[0,1,2].map(i => (
                        <span key={i} style={{
