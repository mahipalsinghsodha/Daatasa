...
const NotifItem = ({ notif, onMarkRead }) => {
  ...
  return (
    <div
      ...
      onMouseEnter={e => { if (!notif.isRead) e.currentTarget.style.background = 'rgba(245,197,24,0.06)' }}
      onMouseLeave={e => { if (!notif.isRead) e.currentTarget.style.background = 'rgba(245,197,24,0.04)'; else e.currentTarget.style.background = 'transparent' }}
    >
